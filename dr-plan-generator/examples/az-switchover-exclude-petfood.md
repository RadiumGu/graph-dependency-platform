...
### Step phase-2.7: `verify_lambda_function` — petadoption-lambda [Tier2]
...
### Step rollback-phase-2.3: `rollback_scale_up_and_verify` — payforadoption (requires approval) [Tier1]
...
### Step rollback-phase-2.4: `rollback_scale_up_and_verify` — pethistory (requires approval) [Tier1]
...
### Step rollback-phase-2.5: `rollback_scale_up_and_verify` — petsearch (requires approval) [Tier0]
...
### Step rollback-phase-2.6: `rollback_scale_up_and_verify` — petsite (requires approval) [Tier0]
...
### Step rollback-phase-2.7: `rollback_verify_k8s_service_endpoints` — petsite-svc (requires approval) [Tier0]
...
### Step rollback-phase-2.8: `rollback_verify_k8s_service_endpoints` — petsearch-svc (requires approval) [Tier0]
