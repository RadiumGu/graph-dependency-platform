#!/usr/bin/env python3
"""verify_cache_direct.py — Direct 引擎 Prompt Caching 生效验证。

连跑同一问题 3 次：
  run 1: 期望 cache_write > 0, cache_read == 0
  run 2/3: 期望 cache_read > 0, cache_write == 0
...
from neptune.nl_query_direct import DirectBedrockNLQuery  # noqa: E402

Q = "petsite 依赖哪些数据库？"
engine = DirectBedrockNLQuery()
...
# verdict
r1, r2, r3 = rows
ok = (r1.get("cache_write", 0) > 0 and r1.get("cache_read", 0) == 0
