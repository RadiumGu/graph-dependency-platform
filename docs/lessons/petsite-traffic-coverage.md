...
> 📄 **原路径**：`todo/petsite-traffic-coverage_20260829-1518.md`　**成文于**：2026-08-29 15:18
...
其余服务在 56/44 到 67/33 之间，只有 search 是 76/24。**根因不是连接复用，是 Kubernetes 拓扑感知路由** ——详见 `sqs-orphan-and-topology-hints.md`。已修复至 55/45。
